  ...
  <div class="container-fluid" id="footer">
    <div class="row">
      ...
      <div class="col-xs-3 col-xs-offset-1 text-white">
        ...
        <hr>
        <a href="https://www.facebook.com/firman.romansyah.750" target="_blank"><img style="width: 40px; height: 40px; margin-right: 1vw;" src="asset/img/facebook.png"></a>
        <a href="https://www.instagram.com/fromansyah206/" target="_blank"><img style="width: 40px; height: 40px; margin-right: 1vw;" src="asset/img/instagram.png"></a>
